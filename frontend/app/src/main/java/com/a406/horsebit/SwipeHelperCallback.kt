...
class SwipeHelperCallback(private val recyclerViewAdapter : AssetTableItemAdapter)  : ItemTouchHelper.Callback() {
    ...
    private fun getView(viewHolder: RecyclerView.ViewHolder) : View = viewHolder.itemView.findViewById(R.id.llh_AssetTableItem)
